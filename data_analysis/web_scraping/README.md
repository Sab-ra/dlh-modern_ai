...
- [x] Open the given infinite-scroll page in headless Chrome.
- [x] Scroll to the bottom repeatedly, waiting scroll_pause seconds each time, until the page height stops increasing.
- [x] Find every div.thumbnail product card and extracts:
- [x] "title": the product name (from the title attribute of <a class="title">)
- [x] "price": the price (text of <h4 class="price">)
- [x] "description": the short description (text of <p class="description">)
- [x] "rating": the star count (number of <p class="ws-icon ws-icon-star"> under .ratings)
- [x] Skip duplicate products by tracking (title, price) pairs.
- [x] Return a list of unique product dicts, e.g.
- [x] Use only Selenium’s execute_script for scrolling and its element-finding APIs for extraction.
